import{x as l}from"./lit-element.Wy23cYDu.js";import{d,e as u,w as b,x as g,l as h,p as v,y as f,z as k,q as x,t as C,g as w,A as S,D as y}from"./defineComponents.CVI5q4ti.js";import"./config.BLuXb-rQ.js";import"./directive-helpers.DzWiHt87.js";import"./iframe-Dz6tlXcu.js";import"../sb-preview/runtime.js";d(S,w,C,x,k,f,v,h,g,b,u);const $={title:"Form",component:"igc-form",parameters:{docs:{description:{component:`The form is a component used to collect user input from
interactive controls.`}},actions:{handles:["igcSubmit","igcReset"]}},argTypes:{novalidate:{type:"boolean",description:"Specifies if form data validation should be skipped on submit.",control:"boolean",table:{defaultValue:{summary:!1}}}},args:{novalidate:!1}};Object.assign($.argTypes,{disabled:{type:"boolean",description:"Disable input fields",control:"boolean",defaultValue:!1},outlined:{type:"boolean",description:"Mark input fields as outlined",control:"boolean",defaultValue:!1}});const I=()=>{const e=document.querySelector("igc-date-time-input");e==null||e.stepUp(y.Date)},D=()=>{const e=document.querySelector("igc-date-time-input");e==null||e.stepDown()},F=()=>{const e=document.querySelector("igc-date-time-input");e==null||e.clear()},q=({novalidate:e,disabled:a,outlined:n})=>{const o=["Male","Female"],p=new Date(2020,2,3),m=[{make:"Volvo",group:"Swedish cars"},{make:"Saab",group:"Swedish cars"},{make:"Mercedes",group:"German cars"},{make:"Audi",group:"German cars"}];return l`
...
>
  `},t=q.bind({});document.addEventListener("igcSubmit",function(e){const n=e.detail;console.log("Form data:");for(const o of n.entries())console.log(o[0]+", "+o[1]);console.log("")});var c,r,s;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`({
  novalidate,
  disabled,
  outlined
}: IgcFormArgs) => {
...
>
  \`;
}`,...(s=(r=t.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};const E=["Basic"];export{t as Basic,E as __namedExportsOrder,$ as default};
