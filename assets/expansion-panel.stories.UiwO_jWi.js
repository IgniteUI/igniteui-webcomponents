import{x as d}from"./lit-element.Wy23cYDu.js";import{d as g,i as C,v as m}from"./defineComponents.CVI5q4ti.js";import"./config.BLuXb-rQ.js";import"./directive-helpers.DzWiHt87.js";import"./iframe-Dz6tlXcu.js";import"../sb-preview/runtime.js";g(m);const v={title:"ExpansionPanel",component:"igc-expansion-panel",parameters:{docs:{description:{component:`The Expansion Panel Component provides a way to display information in a toggleable way -
compact summary view containing title and description and expanded detail view containing
additional content to the summary header.`}},actions:{handles:["igcOpening","igcOpened","igcClosing","igcClosed"]}},argTypes:{open:{type:"boolean",description:"Indicates whether the contents of the control should be visible.",control:"boolean",table:{defaultValue:{summary:!1}}},disabled:{type:"boolean",description:"Get/Set whether the expansion panel is disabled. Disabled panels are ignored for user interactions.",control:"boolean",table:{defaultValue:{summary:!1}}},indicatorPosition:{type:'"start" | "end" | "none"',description:"The indicator position of the expansion panel.",options:["start","end","none"],control:{type:"inline-radio"},table:{defaultValue:{summary:"start"}}}},args:{open:!1,disabled:!1,indicatorPosition:"start"}};C("ferris",`<svg width="100%" height="100%" viewBox="0 0 1200 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
...
</svg>`);C("ferris-greet",`<svg width="100%" height="100%" viewBox="0 0 1200 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
<g id="Layer-1" serif:id="Layer 1">
...
</svg>`);function u({detail:e}){e.querySelector('[slot="indicator"]').textContent="💥"}function f({detail:e}){e.querySelector('[slot="indicator"]').textContent="💣"}const n={render:e=>d`
    <igc-expansion-panel
  ...
  `},t={render:({disabled:e,indicatorPosition:i,open:a})=>d`
  ...
  `};var o,r,s;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: args => html\`
    <igc-expansion-panel
  ...
  \`
}`,...(s=(r=n.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};var l,p,c;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: ({
    disabled,
    indicatorPosition,
    open
  ...
  \`
}`,...(c=(p=t.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};const z=["Basic","IndicatorSlots"];export{n as Basic,t as IndicatorSlots,z as __namedExportsOrder,v as default};
