...
3. Follow the [skill-authoring](https://github.com/IgniteUI/igniteui-webcomponents/blob/master/.agents/skills/skill-authoring/SKILL.md) rules and the structure of existing skills

For skills related to **contributing to the library itself** (creating components, reviewing PRs, etc.), see [`.agents/skills/`](https://github.com/IgniteUI/igniteui-webcomponents/tree/master/.agents/skills).
