import{x as i,b as D}from"./lit-element.Wy23cYDu.js";import{d as O,i as P,o as I,e as A,Q as L}from"./defineComponents.CVI5q4ti.js";import{x as M,z as H}from"./health.B5ghXXgr.js";import{d as j,f as G,a as Z}from"./story.DvBJWGBA.js";import"./config.BLuXb-rQ.js";import"./directive-helpers.DzWiHt87.js";import"./iframe-Dz6tlXcu.js";import"../sb-preview/runtime.js";const z=D`
<?xml version="1.0" ?>
<svg
  viewBox="0 0 24 24"
...
`,a={icons:[M,H],svg:z,emoji:["😣","😔","😐","🙂","😆"].map(e=>i`<igc-rating-symbol>
      ...
      </igc-rating-symbol>`),hoverListener:function(e){const n=["Select a value","Terrible","Bad","Meh","Great","Superb"];document.getElementById("selection").textContent=`${n[Math.ceil(e.detail)]??"Unknown"}`},renderSymbols:function(e,n){return Array.from({length:e},()=>n())}};O(L,A);a.icons.forEach(e=>P(e.name,e.value));const B={title:"Rating",component:"igc-rating",parameters:{docs:{description:{component:`Rating provides insight regarding others' opinions and experiences,
...
}`,...(T=(V=b.parameters)==null?void 0:V.docs)==null?void 0:T.source}}};const K=["Default","SingleSelection","Slots","Form"];export{m as Default,b as Form,v as SingleSelection,u as Slots,K as __namedExportsOrder,B as default};
