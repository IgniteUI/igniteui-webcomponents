import{v as c,M as r,D as s}from"./socialMedia.DmrXeeV-.js";import{x as o}from"./lit-element.Wy23cYDu.js";import{d,i as g,j as l,k as m,a as h}from"./defineComponents.CVI5q4ti.js";import"./config.BLuXb-rQ.js";import"./directive-helpers.DzWiHt87.js";import"./iframe-Dz6tlXcu.js";import"../sb-preview/runtime.js";d(h,m,l);const u=[c,r,s];u.forEach(t=>{g(t.name,t.value)});const j={title:"Card",component:"igc-card",parameters:{docs:{description:{component:"A container which wraps different elements related to a single subject"}}},argTypes:{elevated:{type:"boolean",description:"Sets card elevated style, otherwise card looks outlined.",control:"boolean",table:{defaultValue:{summary:!1}}}},args:{elevated:!1}},p=({elevated:t=!1})=>o`
  ...
  `,a=p.bind({});var i,e,n;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`({
  elevated = false
}: IgcCardArgs) => {
  return html\`
    <div style="display:flex; margin:16px">
  ...
  \`;
}`,...(n=(e=a.parameters)==null?void 0:e.docs)==null?void 0:n.source}}};const k=["Basic"];export{a as Basic,k as __namedExportsOrder,j as default};
