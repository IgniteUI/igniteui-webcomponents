...
module.exports = {
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          '(^|/)types\.ts$', // type-only modules (only consumed via import type)
          '(^|/)constructor\.ts$', // mixin constructor types
          '(^|/)tree\.common\.ts$', // shared tree types
        ],
      },
      to: {},
    },
  ...
  options: {
    ...
    // false (the default): don't include TypeScript pre-compilation dependencies
    // (import type, triple-slash references). Setting to true causes false-positive
    // circular dependency warnings since the codebase uses 'import type' deliberately
...
// generated: dependency-cruiser@17.3.10 on 2026-04-20T06:26:34.445Z
